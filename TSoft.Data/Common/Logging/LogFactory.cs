...
namespace TSoft.Data.Common.Logging
{
    public static class LogFactory
    {
        ...
        /// The default logger is Log4Net
        /// </summary>
        /// <returns>A concrete logger, usually an Log4NetLogger or LogLogger/returns>
        public static ILogger Logger()
        {
            string defaultLoggerTypeName = "TSoft.Data.Common.Logging.Log4Net";
