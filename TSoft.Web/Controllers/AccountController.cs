...
namespace TSoft.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            return View("Login", "_AdsLayout1", model);
        }
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                var userNew = _unitOfWork.UserProfile.GetAll()
                    .Where(u => u.UserName.ToLower().Equals(model.UserName.ToLower()));

                if (userNew == null)
                {
                    _unitOfWork.UserProfile.Add(new UserProfile { UserName = model.UserName});
                    _unitOfWork.Commit();
